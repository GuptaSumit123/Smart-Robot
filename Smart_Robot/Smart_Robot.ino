...
// Key Control Command
     ...
     if(bt_ir_data == 1){forword(); }  // if btis '1' the DC motor will go forward
else if(bt_ir_data == 2){backword();}  // if bt is'2' the motor will Reverse
else if(bt_ir_data == 3){turnLeft();}  // if bt is '3' the motor will turn left
else if(bt_ir_data == 4){turnRight();} // if bt is '4' the motor will turn right
else if(bt_ir_data == 5){Stop(); }     // if  bt is'5' the motor will Stop
